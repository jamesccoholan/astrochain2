  ...
  render() {
    return (
      <div class="Header">
        ...
        >
          <source
            src={this.getVideo(this.state.innerWidth)}
            type="video/mp4"
          />
        </video>
        {/*<div class="socials"><SocialIcons /></div>*/}
        <div class="landing-bottom-text">
        What happens when you put a Bored Ape, a Cool Cat, a World of Women, a Roboto {"&"} a Doodle on a reality show together? We have no idea, but we{"’"}re betting they make some jokes, make some mistakes, and maybe even make out?!<br /><br/>

  ...
  return (
    <div className="rarity-section">
      ...
      <div className="rarity-description">
        ...
        together here on The R3eal Metaverse. Over 100 different traits
        algorithmi- cally combine iconic locations in Los Angeles with award
        winning animation to generate over 4 million combinations. The Mint will
        randomly produce XXXX unique Producer Passes. In addition, 20 Ultra Rare
        Passes will be created. If you're lucky enough to mint one of these rare

  ...
  return (
    <div class="rarity-section">
      ...
      <div class="rarity-description">
        Our Producer Pass is designed to become your Twitter banner. Our traits
        combine iconic locations in Los Angeles with award-winning animation to
        generate over a million combinations. The Mint will randomly produce
        7000 unique Producer Passes.
      </div>
      <img
      ...
      <div class="rarity-description">
        ...
        enough to mint one of these NFTs you will automatically receive bonus

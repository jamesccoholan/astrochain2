...
function Season1() {
  return (
    <div class="season-1-background">
        ...
        <Stack direction={{xs:'column', sm:'column', md: 'row', lg:'row'}} spacing={{xs:0, sm:2, md:2, lg:4}} alignItems="center" width="100%" height="auto" object-fit="cover" overflow="auto" style={{ justifyContent: 'center', padding: '20px 0 40px 0' }}>
        ...
        <img src="/assets/Website 2/04 Episode Guide/EpisodeGuide_PlaylistImage.png" class="playlist-img" />
      </Stack>
    </div>
  );
}
